        ...
        <div className="flex-1 h-full">
          {!isRevealed ? (
            <button
              ...
              className={cn(
                "w-full h-full font-mono text-sm font-black tracking-[0.2em] uppercase transition-all btn-depress focus-ring rounded",
                canSubmit
                  ? "cta-gradient"
            ...
            <button
              ...
              className="w-full h-full cta-gradient font-mono text-sm font-black tracking-[0.2em] uppercase btn-depress animate-slide-up focus-ring rounded"
            >
