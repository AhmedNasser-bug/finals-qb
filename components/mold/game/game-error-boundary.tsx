      ...
      <div className="min-h-screen bg-background flex flex-col items-center justify-center gap-6 p-8">
        <div className="border border-red-500/40 bg-red-500/5 rounded p-6 max-w-md w-full text-center space-y-4" role="alert">
          ...
          <button
            ...
            className="mt-2 px-4 py-2 text-xs font-mono tracking-widest border border-primary text-primary hover:bg-primary hover:text-primary-foreground transition-colors rounded focus-ring"
          >
            RETURN TO HOME
          </button>
        </div>
