        ...
        <footer className="flex flex-col md:flex-row items-center justify-between gap-4 pt-8 border-t border-[var(--tw-hex-4e4632)]/10">
          ...
          <div className="flex gap-3 w-full md:w-auto">
            <button
              ...
              title="Return home"
              className="flex-1 md:flex-none px-8 py-3 bg-[#353534] text-[#fecc17] font-mono text-xs font-black tracking-widest uppercase btn-depress hover:bg-[#3d3c3b] transition-colors focus-ring focus-visible:ring-offset-2 focus-visible:ring-offset-[#1c1b1b] rounded"
            >
              RETURN TO HOME
            </button>
            <button
              ...
              title="Play again"
              className="flex-1 md:flex-none px-10 py-3 cta-gradient font-mono text-xs font-black tracking-widest uppercase btn-depress focus-ring focus-visible:ring-offset-2 focus-visible:ring-offset-[#1c1b1b] rounded border-glow"
            >
              PLAY AGAIN
            </button>
          </div>
