    ...
    >
      <div className="w-full max-w-lg bg-panel border border-border rounded flex flex-col max-h-[90vh]">
        ...
        <div className="flex items-center justify-between px-5 py-4 border-b border-border">
          ...
          <button
            onClick={onClose}
            className="text-muted-foreground hover:text-foreground transition-colors p-1 rounded focus-ring focus-visible:outline-none"
        ...
        <div className="h-1 bg-secondary">
          ...
          `}</style>
          <div className="h-full bg-primary transition-all duration-500 ach-gallery-progress" />
        </div>
        ...
        <div className="px-5 py-3 border-t border-border flex justify-end">
          <button
            ...
            className="text-xs font-mono text-muted-foreground hover:text-destructive transition-colors focus-ring focus-visible:outline-none rounded px-1"
          >
            RESET ALL
          </button>
        </div>
...
function LockIcon({ className }: { className?: string }) {
  return (
    <svg className={className} aria-hidden="true" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round">
