      ...
      <div className="space-y-5">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="space-y-2.5">
            ...
            <div className="h-3 bg-muted border border-border flex gap-0.5 p-0.5 rounded-sm overflow-hidden" aria-label={`Average response time is ${averageResponseTimeMs} milliseconds`}>
              {Array.from({ length: 10 }).map((_, i) => {
                ...
                return (
                  <div 
                    ...
                    className={cn(
                      "h-full flex-1 transition-all duration-300", 
                      isFilled ? "bg-primary" : "bg-muted-foreground/20"
                    )} 
                  />
                )
              })}
