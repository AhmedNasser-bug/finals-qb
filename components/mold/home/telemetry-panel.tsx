      ...
      <div className="space-y-5">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="space-y-2.5">
            ...
            <div className="h-3 bg-secondary border border-border/60 flex gap-0.5 p-0.5 rounded-sm overflow-hidden" aria-label={`Average response time is ${averageResponseTimeMs} milliseconds`}>
              {Array.from({ length: 10 }).map((_, i) => {
                ...
                return (
                  <div 
                    ...
                    className={cn(
                      "h-full flex-1 transition-all duration-300", 
                      isFilled ? "bg-primary" : "bg-secondary/60"
                    )} 
                  />
                )
              })}
            ...
            <div className="flex justify-between font-mono text-[8px] text-muted-foreground/60 px-0.5 pt-0.5 select-none">
              <span>SLOWER (&gt;5s)</span>
