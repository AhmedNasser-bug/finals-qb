...
import { Step1ContentType } from "./wizard-steps/step-1-content-type"
import { Step2StyleBias } from "./wizard-steps/step-2-style-bias"
import { Step3CategoryFocus } from "./wizard-steps/step-3-category-focus"
import { Step4CopyPrompt } from "./wizard-steps/step-4-copy-prompt"
import { Step5PasteMerge } from "./wizard-steps/step-5-paste-merge"
    ...
    <div className="fixed inset-0 z-50 bg-background/95 backdrop-blur-sm flex items-center justify-center p-4 animate-fade-in select-none">
      <div className="w-full max-w-5xl h-[88vh] flex flex-col gap-0 border border-border bg-[#0a0b0d] rounded-none overflow-hidden border-glow transition-all duration-300">
        ...
        <div className="flex-1 px-8 py-6 overflow-y-auto min-h-0 bg-[#0a0b0d]">
          ...
          {step === 2 && (
            <Step2StyleBias styleBias={styleBias} setStyleBias={setStyleBias} />
          )}
