...
export function WizardStepContentQuantity({
  contentType,
  setContentType,
  questionCount,
  setQuestionCount,
  flashcardCount,
  setFlashcardCount,
}: WizardStepContentQuantityProps) {
  return (
...
export interface WizardStepStyleBiasProps {
  styleBias: "theoretical" | "technical" | "balanced"
  setStyleBias: (bias: "theoretical" | "technical" | "balanced") => void
}

export function WizardStepStyleBias({
  styleBias,
  setStyleBias,
}: WizardStepStyleBiasProps) {
  return (
    <div className="space-y-6 animate-slide-up">
              <div className="space-y-1">
...
export interface WizardStepCategoryFocusProps {
...
export function WizardStepCategoryFocus({
  categoryFocus,
  setCategoryFocus,
  existingCategories,
  selectedCategory,
...
export interface WizardStepPromptCopyProps {
  promptCopied: boolean
  handleCopyPrompt: () => void
  compiledPrompt: string
}

export function WizardStepPromptCopy({
  promptCopied,
  handleCopyPrompt,
  compiledPrompt,
}: WizardStepPromptCopyProps) {
  return (
    <div className="space-y-6 animate-slide-up">
              <div className="space-y-1">
                <span className="text-[10px] font-mono tracking-widest text-[#4ae176] uppercase font-bold">
...
export interface WizardStepPasteMergeProps {
  jsonInput: string
...
export function WizardStepPasteMerge({
  jsonInput,
  handleJsonChange,
  validationState,
  validationResult,
  parsedPreview,
}: WizardStepPasteMergeProps) {
  return (
    <div className="space-y-6 animate-slide-up">
              <div className="space-y-1">
                <span className="text-[10px] font-mono tracking-widest text-[#4ae176] uppercase font-bold">
