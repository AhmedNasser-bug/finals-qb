...
export function Step2StyleBias({ styleBias, setStyleBias }: Step2Props) {
  return (
    <div className="space-y-6 animate-slide-up">
      <div className="space-y-1">
...
export function Step4CopyPrompt({ compiledPrompt, promptCopied, handleCopyPrompt }: Step4Props) {
  return (
    <div className="space-y-6 animate-slide-up">
      <div className="space-y-1">
        <span className="text-[10px] font-mono tracking-widest text-[#4ae176] uppercase font-bold">
...
export function Step5PasteMerge({ jsonInput, handleJsonChange, validationState, validationResult, parsedPreview }: Step5Props) {
  return (
    <div className="space-y-6 animate-slide-up">
      <div className="space-y-1">
        <span className="text-[10px] font-mono tracking-widest text-[#4ae176] uppercase font-bold">
