...
export function Step1ContentType({ contentType, setContentType, questionCount, setQuestionCount, flashcardCount, setFlashcardCount }: Step1Props) {
  return (
...
export function Step2PedagogicalStyle({ styleBias, setStyleBias }: Step2Props) {
  return (
          <div className="space-y-6 animate-slide-up">
              <div className="space-y-1">
...
export function Step3CategoryFocus({ categoryFocus, setCategoryFocus, existingCategories, selectedCategory, setSelectedCategory, newCategoryName, setNewCategoryName }: Step3Props) {
  return (
          <div className="space-y-6 animate-slide-up">
              <div className="space-y-1">
                <span className="text-[10px] font-mono tracking-widest text-primary uppercase font-bold">
...
export function Step4CopyPrompt({ promptCopied, handleCopyPrompt, compiledPrompt }: Step4Props) {
  return (
          <div className="space-y-6 animate-slide-up">
              <div className="space-y-1">
                <span className="text-[10px] font-mono tracking-widest text-[#4ae176] uppercase font-bold">
...
export function Step5PasteMerge({ jsonInput, setJsonInput, validationState, validationResult, parsedPreview, handleJsonChange }: Step5Props) {
  return (
          <div className="space-y-6 animate-slide-up">
              <div className="space-y-1">
                <span className="text-[10px] font-mono tracking-widest text-[#4ae176] uppercase font-bold">
