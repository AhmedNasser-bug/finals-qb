...
export function Step2Style({ state, updateState }: Step2StyleProps) {
  const { styleBias } = state
  ...
  return (
    <div className="space-y-6 animate-slide-up">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <button
          type="button"
          onClick={() => updateState({ styleBias: "theoretical" })}
          className={cn(
        ...
        <button
          type="button"
          onClick={() => updateState({ styleBias: "technical" })}
          className={cn(
            "p-6 border text-left flex flex-col justify-between gap-4 transition-all duration-150 cursor-pointer rounded-none min-h-[170px]",
            styleBias === "technical"
        ...
        <button
          type="button"
          onClick={() => updateState({ styleBias: "balanced" })}
          className={cn(
            "p-6 border text-left flex flex-col justify-between gap-4 transition-all duration-150 cursor-pointer rounded-none min-h-[170px]",
            styleBias === "balanced"
              ? "border-primary bg-primary/5 border-glow"
