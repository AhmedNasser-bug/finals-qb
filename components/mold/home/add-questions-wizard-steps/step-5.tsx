                ...
                <div className="grid grid-cols-3 gap-4 bg-zinc-950/50 p-4 border border-zinc-900 text-zinc-300 font-mono text-[11px]">
                  <div>
                    ...
                    <span className="text-lg font-bold text-white">
                      {parsedPreview.questions.filter((q: any) => q.id !== "q-default-1").length}
                    </span>
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <span className="text-xs font-bold text-white truncate block">
                      {Array.from(new Set(parsedPreview.questions.filter((q: any) => q.id !== "q-default-1").map((q: any) => q.category))).map(cat => formatLabel(cat as string)).join(", ") || "—"}
                    </span>
                  </div>
                </div>
              )}
