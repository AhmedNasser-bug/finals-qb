...
export function HeroHeader({
  ...
  return (
    <header className={cn("border-b border-border bg-panel", className)}>
      ...
      <div className="flex flex-wrap items-center gap-4 px-6 py-3 border-b border-border/50 bg-muted/40">
        <div className="flex items-center gap-2.5 min-w-0">
          ...
          <Image
            ...
            priority
          />
          <span className="text-[10px] font-mono tracking-widest text-emerald-500 dark:text-emerald-400 uppercase font-bold shrink-0">
            MASTERY_PROTOCOL //
          </span>
        ...
        <div className="ml-auto flex items-center gap-2">
          {onChangeSubject && (
            <button type="button"
              ...
              className="text-[10px] font-mono font-bold px-3 py-1.5 border border-border bg-secondary text-foreground hover:border-primary/80 hover:text-primary transition-all duration-150 focus-ring min-h-[32px] cursor-pointer"
            >
              SWITCH SUBJECT
            </button>
          )}
        ...
        <div className="flex items-center gap-3 mt-4 sm:mt-0 shrink-0">
          <div className="flex flex-col items-end gap-1" role="status" aria-live="polite">
            ...
            <div 
              ...
              aria-valuemin={0}
              aria-valuemax={100}
              aria-valuenow={total > 0 ? (unlocked / total) * 100 : 0}
            >
              <div 
