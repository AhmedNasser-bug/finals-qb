...
export function BottomMobileNav({
  ...
  return (
    <nav
      ...
      className="md:hidden fixed bottom-0 left-0 right-0 h-16 bg-[#131313] border-t border-border z-50 flex justify-around items-center px-4 select-none"
    >
      <button
        onClick={() => {
          setView("home")
        ...
        aria-label="Go to core game modes"
        title="Core Game Modes"
        className={cn(
      ...
      <button
        ...
        aria-label="Open encyclopedia data"
        title="Encyclopedia"
