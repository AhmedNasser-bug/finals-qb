...
export function HeaderWell({
  ...
  return (
    <header className="mb-10 relative select-none">
      <div className="bg-panel p-8 border-l-4 border-primary border-y border-r border-border inner-recess rounded-r-md">
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 relative z-10">
          <div className="space-y-1 min-w-0 flex-1">
            <div className="font-mono text-[10px] text-primary mb-1 tracking-[0.3em] uppercase opacity-70">
              ACTIVE SUBJECT
            </div>
            <h1 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-headline font-black tracking-tight text-foreground uppercase leading-none break-words break-all">
          ...
          <div className="flex flex-col items-start md:items-end gap-1.5 shrink-0 bg-muted/50 p-4 border border-border rounded">
            <div className="font-mono text-[9px] text-primary uppercase tracking-widest font-bold">
              AVERAGE ACCURACY
            </div>
            <div className="text-3xl sm:text-4xl font-headline font-black text-emerald-500 dark:text-emerald-400">
