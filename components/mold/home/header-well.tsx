    ...
    <header className="mb-10 relative select-none">
      <div className="bg-panel p-8 border-l-4 border-primary inner-recess rounded-r-md">
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 relative z-10">
          ...
          <div className="flex flex-col items-start md:items-end gap-1.5 shrink-0 bg-surface/50 p-4 border border-border/80 rounded">
            <div className="font-mono text-[9px] text-primary uppercase tracking-widest font-bold">
              AVERAGE ACCURACY
            </div>
            <div className="text-3xl sm:text-4xl font-headline font-black text-primary">
