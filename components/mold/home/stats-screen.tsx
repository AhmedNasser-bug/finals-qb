    ...
    <div className="space-y-8 select-none animate-fade-in pb-16">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="p-5 border border-border bg-[#101115] rounded relative overflow-hidden group hover:border-zinc-700 transition-all duration-300">
          ...
          <p className="font-mono text-[8px] uppercase tracking-widest text-zinc-500 font-bold">
            QUIZZES COMPLETED
          </p>
        ...
        <div className="p-5 border border-border bg-[#101115] rounded relative overflow-hidden group hover:border-zinc-700 transition-all duration-300">
          ...
          <div className="flex items-baseline gap-3 mt-2">
            ...
            {stats.totalRuns > 0 && (
              <span
                className={cn(
                  "font-mono text-sm font-black px-1.5 py-0.5 rounded border border-glow",
                  gradeBgColor(avgGrade),
                )}
              >
                {avgGrade}
              </span>
          ...
          <p className="text-[9px] text-zinc-500 font-mono mt-3">
            BEST SINGLE ATTEMPT: {stats.bestScore}%
          </p>
        </div>
        ...
        <div className="p-5 border border-border bg-[#101115] rounded relative overflow-hidden group hover:border-zinc-700 transition-all duration-300">
          ...
          <p className="text-[9px] text-zinc-500 font-mono mt-3">
            {stats.averageResponseTimeMs
              ? `${Math.round(stats.averageResponseTimeMs)}ms per question`
              : "untimed"}
          </p>
        </div>
      </div>
              ...
              {missions.map((mission) => (
                ...
                >
                  ...
                  >
                    {mission.completed && (
                      <CheckCircle2
                        className="w-4 h-4 fill-current text-primary shrink-0"
                        aria-hidden="true"
                      />
                    )}
                  </div>
            ...
            <div className="border border-destructive/20 bg-destructive/5 rounded p-5 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
              <div className="space-y-1">
                ...
                <p className="text-[10px] text-zinc-400 max-w-md">
                  This action deletes all your completed quizzes, study streaks,
                  best streak records, and progress stats. This cannot be
                  undone.
                </p>
              </div>
