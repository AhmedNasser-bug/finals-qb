  ...
  return (
    <>
      <p className="text-xs text-muted-foreground leading-relaxed">
        The entire subject is encoded directly into the URL — no server
        required. Anyone with the link can import it instantly.
      </p>
      ...
      {encoding && (
        <div
          role="status"
          aria-live="polite"
          className="flex items-center gap-2 text-xs font-mono text-muted-foreground animate-pulse"
        >
      ...
      {!encoding && !encodeError && (
        <>
          ...
          >
            ...
            <span>
              Compressed size:{" "}
              <span className="text-foreground">{sizeKb} KB</span>
              {isSizeLarge && (
...
export function FileTabContent({ subject, onDownload }: FileTabContentProps) {
  return (
    <>
      <p className="text-xs text-muted-foreground leading-relaxed">
        Download the subject as a raw{" "}
        <span className="font-mono text-foreground">.json</span> file. The
        recipient can import it directly into Finalist using the subject
        importer.
      </p>
