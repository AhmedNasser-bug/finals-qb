  ...
  return (
    <div className="lg:col-span-4 flex flex-col gap-6 select-none lg:sticky lg:top-6 h-fit">
      <div className="flex items-center gap-2">
        ...
        <span className="font-mono text-[10px] font-bold tracking-[0.2em] text-foreground/80 uppercase">
          SYSTEM_NEURAL_CORE
        </span>
      </div>

      {/* Decorative Brain/Cortex Image Card */}
      <div className="aspect-square bg-card border border-border p-2.5 relative overflow-hidden group rounded-md select-none border-glow transition-all duration-500">
        <img
          alt=""
          role="presentation"
          aria-hidden="true"
        ...
        <div className="absolute top-4 right-4 bg-background/85 px-2 py-0.5 font-mono text-[8px] text-primary border border-primary/20 tracking-wider">
          SYS_FEED
        </div>

        {/* BOTTOM LEFT: Cortex identifier */}
        <div className="absolute bottom-4 left-4 bg-background/85 px-3 py-1 font-mono text-[9px] text-primary border border-primary/20 uppercase tracking-widest font-bold">
          REF_ID: حلتيتة
        </div>
      </div>

      {/* Neural Uptime and Stats Telemetry Panel */}
      <div className="bg-panel border border-border p-5 rounded-md space-y-4 font-mono text-[10px]">
        ...
        <div className="space-y-3">
          ...
          <div className="flex justify-between border-b border-border/60 pb-2">
            ...
            <span className="font-bold text-foreground">4,096 ACTIVE</span>
          </div>
          <div className="flex justify-between border-b border-border/60 pb-2">
