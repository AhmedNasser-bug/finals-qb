    ...
    <section className="flex flex-col gap-5">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
        ...
        <button
          ...
          className={cn(
            "flex flex-col items-center justify-center gap-3 p-6 border border-dashed border-border text-muted-foreground bg-panel transition-all duration-300 ease-out hover:-translate-y-0.5 hover:border-primary/40 hover:text-primary hover:bg-secondary/60 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 focus-visible:ring-offset-background min-h-[140px]",
