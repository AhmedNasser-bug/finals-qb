...
export function InfoToolbox({ content }: { content: string }) {
  ...
  return (
    ...
    >
      ...
      {isOpen && (
        <div className="absolute top-full left-1/2 -translate-x-1/2 mt-2.5 w-64 p-3 bg-popover border border-primary/30 shadow-2xl rounded text-[11px] leading-relaxed text-popover-foreground z-50 font-sans normal-case tracking-normal border-glow text-left animate-fade-in">
