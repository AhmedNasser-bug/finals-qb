...
export function ShareIcon({ 'aria-hidden': ariaHidden }: { 'aria-hidden'?: boolean | "true" | "false" } = {}) {
  return (
    <svg className="w-4 h-4" aria-hidden={ariaHidden} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round">
