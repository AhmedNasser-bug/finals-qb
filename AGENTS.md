...
14. **Consolidated Test Verification:** The official test execution command is:
    `node --experimental-strip-types --import ./test-runner.mjs --test lib/utils/accuracy.test.ts lib/achievement/achievement-logic.test.ts lib/subject/active-subject-store.test.ts lib/utils/crypto-utils.test.ts lib/utils/logger.test.ts lib/types/mold-types.test.ts lib/subject/subject-persistence.test.ts lib/utils/url-shortener.test.ts lib/utils/utils.test.ts lib/utils/user-storage.test.ts`
