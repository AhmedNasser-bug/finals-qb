...
// ─── Normalisation Helpers (Phase 1) ──────────────────────────────────────────

function normalizeFlashcards(obj: Record<string, unknown>, warnings: string[]): void {
...
function normalizeTerminology(obj: Record<string, unknown>, warnings: string[]): void {
  if (
...
function normalizeAchievements(obj: Record<string, unknown>, warnings: string[]): void {
...
// ─── Strict Validation Helpers (Phase 2) ──────────────────────────────────────

function validateConfig(obj: Record<string, unknown>, errors: string[]): void {
...
function validateQuestions(obj: Record<string, unknown>, errors: string[]): void {
...
function validateFlashcards(obj: Record<string, unknown>, errors: string[], warnings: string[]): void {
...
function validateTerminology(obj: Record<string, unknown>, warnings: string[]): void {
  if (
    typeof obj.terminology !== "object" ||
    obj.terminology === null ||
    Array.isArray(obj.terminology)
...
function validateAchievements(obj: Record<string, unknown>, warnings: string[]): void {
...
export function validateSubjectData(raw: unknown): ValidationResult {
  ...
  validateConfig(obj, errors)
  validateQuestions(obj, errors)
  validateFlashcards(obj, errors, warnings)
  validateTerminology(obj, warnings)
  validateAchievements(obj, warnings)
