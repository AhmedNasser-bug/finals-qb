...
export const GAME_MODES: GameMode[] = [
  {
    id: "speedrun",
    label: "Speedrun",
    description: "Answer questions against a ticking clock to test your speed.",
    category: "challenge",
    tag: "Time Attack",
  },
  {
    id: "blitz",
    label: "Blitz",
    description: "Quick, rapid-fire daily review with random questions.",
    category: "challenge",
    tag: "Rapid Fire",
  },
  {
    id: "hardcore",
    label: "Hardcore",
    description: "High-difficulty questions only to test your skills.",
    category: "challenge",
    tag: "Hard Only",
  },
  {
    id: "survival",
    label: "Survival",
    description: "Outlast the shrinking timer that gets faster every few questions.",
    category: "challenge",
    tag: "Progressive",
  },
  {
    id: "practice",
    label: "Practice",
    description: "Relaxed and untimed study. Select a topic to focus on.",
    category: "learning",
    tag: "Untimed",
  },
  {
    id: "flashcards",
    label: "Flashcards",
    description: "Flip cards to memorize key definitions and terms.",
    category: "learning",
    tag: "Recall",
  },
  {
    id: "full-revision",
    label: "Full Revision",
    description: "Go through all questions in their original order, like a real exam.",
    category: "learning",
    tag: "Exam Mode",
  },
]
