...
This step-by-step developer playbook outlines initialization commands, testing workflows, and PR validation rules.
...
- **Architectural boundaries:** Changes to monolithic UI files should isolate nested elements and use explicit interfaces. Any logic modified must align with granular documents in `docs/architecture/cross-module-traceability-manual.md`.
