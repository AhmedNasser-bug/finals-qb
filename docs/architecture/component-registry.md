...
#### Service: tenant-a
- **Image**: node:alpine
- **Data Pipeline / Output Isolation**: .next-tenant-a
- **Port Mapping**: "3001:3000"
#### Service: tenant-b
- **Image**: node:alpine
- **Data Pipeline / Output Isolation**: .next-tenant-b
- **Port Mapping**: "3002:3000"

### Backend Server Actions
### Backend Service: `getExamplesManifest`

- **Type**: Server Action

- **Data Pipeline**: Client component invocation -> Server Action -> File System / Database
